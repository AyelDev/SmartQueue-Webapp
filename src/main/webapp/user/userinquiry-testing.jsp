...
font-size: 1rem;
    ...
    <div class="container">
        ...
        <div class="main">
            <!-- Card for General -->
            <div class="card" id="college-registrar-card" onclick="window.location.href='userinquiry';">
                <div class="box">
                    <p>College</p>
                    <h2>Registrar</h2>
                </div>
    ...
    <div id="general-modal" class="modal">
        <div class="modal-content" id="modal-content">
            ...
            <div class="form">
                ...
                <label for="studentIdNo" class="student-id-no-text">Student ID No.  Type '000' for new student</label>
