    ...
    <section class="tables">
        ...
        <div class="table-container">
            ...
            <table id="priority-number-table" class="data-table">
                ...
                <tbody>
                    <tr data-priority="P001" data-name="Cindy mae Labra" data-counter="1" data-purpose="Inquiry">
                        <td>P001</td>
                        <td>2024-09-07</td>
                        <td>14:30</td>
                        <td>Active</td>
                    </tr>
                    <tr data-priority="P002" data-name="Irish E. Cabanero" data-counter="3" data-purpose="Complaint">
                        <td>P002</td>
                        <td>2024-09-07</td>
                        <td>14:32</td>
                        <td>Completed</td>
                    </tr>
                    <tr data-priority="P003" data-name="Ariel Abelgas" data-counter="4" data-purpose="Enrollment">
                        <td>P003</td>
                        <td>2024-09-07</td>
                        <td>14:40</td>
                        <td>Active</td>
    ...
    document.getElementById('recall-button').addEventListener('click', function() {
        if (selectedRow) {
            ...
            newRow.innerHTML = `
                ...
                <td>${new Date().toISOString().slice(11, 16)}</td>
                <td>Active</td>
            `;
            selectedRow.remove();
            document.getElementById('recall-button').disabled = true;
