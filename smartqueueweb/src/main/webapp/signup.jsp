					...
					<div class="loginform-container">
						...
						<div class="form-container">
							<form action=signup_Servlet method=post>
                                    ...
                                    <input type="text" class="firstname-container" required type="text" name="txtFirstname" placeholder="First name"> 
                                    <input type="text" class="lastname-container" required type="text" name="txtLastname" placeholder="Last name">
                                    <input class="username-container"
									required="required" type="text" name="txtUsername" placeholder="Username"> 
                                    <input type="text" class="contactno-container" required type="text" name="txtContactno" placeholder="Contact no.">
                                    
                                    <input type="text" class="email-container" required type="text" name="txtEmail" placeholder="Email">   
